...
<html lang="en">
  ...
  <body>
	...
	<div id="productContainer">
		<div class="row">
			<div id="left_container" class="col-lg-4 col-lg-offset-1">
			...
			<div id="right_container" class="col-lg-6">
				...
				<div>
					<div class="color_container">Colors available </div>
					<c:forEach var="color" items="${productData.productAttributes.color}" >
						<span class="product_color">${color} </span>
					</c:forEach>
				</div>
				<div>
					<div  class="size_container">Size available</div>
					<c:forEach var="prod_size" items="${productData.productAttributes.size}">
						<span class="product_size">${prod_size} </span>
					</c:forEach>
				</div>
