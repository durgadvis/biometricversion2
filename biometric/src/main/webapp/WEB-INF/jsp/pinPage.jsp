	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-lg-offset-3">
				<h2>Please enter the Pin to continue </h2>
				<form:form method="POST" action="/biometric-1/shop/payment/confirm"  modelAttribute="userDetail" class="form-horizontal" id="pinFormValidation">
					<div class="col-lg-9 col-lg-offset-2">
						<div class="form-group col-xs-9 col-xs-offset-2">
							<form:label path="tpin" class="control-label col-xs-4">TPin: </form:label>
							<div class="col-xs-6">
								<form:input class="form-control" path="tpin" name="tpin" required="required" type="password"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-xs-4 col-xs-offset-2">
								<input type="submit" class="submit_buttom btn btn-mg" name ="shop" value="Proceed"/>
							</div>
						</div>
					</div>
				</form:form>
